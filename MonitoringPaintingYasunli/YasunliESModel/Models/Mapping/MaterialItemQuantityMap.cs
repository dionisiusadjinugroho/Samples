...
{
    public class MaterialItemQuantityMap : EntityTypeConfiguration<MaterialItemQuantity>
    {
        public MaterialItemQuantityMap()
        {
            // Primary Key
            ...
            this.ToTable("MaterialItemQuantities", "Inventory");
