...
{
    public class PartTransactionLansirMap : EntityTypeConfiguration<PartTransactionLansir>
    {
        public PartTransactionLansirMap()
        {
            // Primary Key
            ...
            this.ToTable("PartTransactionLansir", "Shared");
