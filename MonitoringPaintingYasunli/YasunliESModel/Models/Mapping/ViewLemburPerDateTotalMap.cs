...
{
    public class ViewLemburPerDateTotalMap : EntityTypeConfiguration<ViewLemburPerDateTotal>
    {
        public ViewLemburPerDateTotalMap()
        {
            // Primary Key
            ...
            this.ToTable("ViewLemburPerDateTotal");
