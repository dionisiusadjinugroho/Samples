...
{
    public class ViewMouldRepairCostingMap : EntityTypeConfiguration<ViewMouldRepairCosting>
    {
        public ViewMouldRepairCostingMap()
        {
            // Primary Key
            ...
            this.ToTable("ViewMouldRepairCosting");
