...
{
    public class ViewItemListNewMap : EntityTypeConfiguration<ViewItemListNew>
    {
        public ViewItemListNewMap()
        {
            // Primary Key
            this.HasKey(t => new { t.ItemID, t.KodeItem, t.ItemName, t.Model, t.Kategori, t.TipeMaterial, t.Kelengkapan, t.BQICSInfoPrefix });
            ...
            this.Property(t => t.ItemComponen)
                .HasMaxLength(50);
            ...
            this.ToTable("ViewItemListNew", "Inventory");
            ...
            this.Property(t => t.ItemComponen).HasColumnName("ItemComponen");
