...
{
    public class DEMOScannerZebraRFID_DeliveryEPSONViewModel : ViewModelBase
    {
        App _application;

        public DEMOScannerZebraRFID_DeliveryEPSONViewModel()
        {
            _application = Application.Current as App;
            ResWidth = _application.MainPage.Width;

            listdatabarcode = new List<QRCodeDeliveryEPSON>();
        }

        public double ResWidth = 0;

        public List<QRCodeDeliveryEPSON> listdatabarcode;
        public List<QRCodeDeliveryEPSON> listDataBarcode
        {
